...
export default function BoatengPraise() {
      ...
      >
        ...
        <div className="md:w-1/2 flex flex-col justify-center">
          <h2 className="text-3xl md:text-4xl font-semibold mb-4">
            <span className="text-pink-500">Kevin-Prince Boateng</span>
          </h2>
          <p className="text-gray-300 leading-relaxed text-lg md:text-xl">
            <span className="text-pink-500 font-semibold">Boateng</span> has openly said he couldn’t believe he shared a pitch with Messi at Barça. 
            His admiration is emotional and fan-like — proof of Messi’s impact even on fellow professionals.
          </p>
        </div>
      </motion.div>
    </section>
