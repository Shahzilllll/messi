...
export default function MbappePraise() {
      ...
      <div className="w-full flex flex-col md:flex-row-reverse items-center gap-10 mb-24">
        ...
        <div className="md:w-1/2 flex flex-col justify-center">
          <h2 className="text-3xl md:text-4xl font-semibold mb-4">
            <span className="text-pink-500">Kylian Mbappé</span>
          </h2>
          <p className="text-gray-300 leading-relaxed text-lg md:text-xl">
            <span className="text-pink-500 font-semibold">Mbappé</span> grew up watching Messi and then became his teammate. 
            The generational link makes his praise special — a future legend acknowledging the king who inspired him.
          </p>
        </div>
      </div>
    </section>
