...
export default function KloppPraise() {
      ...
      >
        ...
        <div className="md:w-1/2 flex flex-col justify-center">
          <h2 className="text-3xl md:text-4xl font-semibold mb-4">
            <span className="text-pink-500">Jürgen Klopp</span>
          </h2>
          <p className="text-gray-300 leading-relaxed text-lg md:text-xl">
            <span className="text-pink-500 font-semibold">Klopp</span>’s admiration for Messi is warm and genuine. 
            He’s spoken about Messi’s ability to bend matches to his will, describing him as a player you simply 
            can’t prepare for — someone who breaks logic.
          </p>
        </div>
      </motion.div>
    </section>
