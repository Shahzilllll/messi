...
export default function RioFerdinandPraise() {
      ...
      >
        ...
        <div className="md:w-1/2 flex flex-col justify-center">
          <h2 className="text-3xl md:text-4xl font-semibold mb-4">
            <span className="text-pink-500">Rio Ferdinand</span>
          </h2>
          <p className="text-gray-300 leading-relaxed text-lg md:text-xl">
            <span className="text-pink-500 font-semibold">Rio</span> breaks down Messi’s greatness with a defender’s eye. 
            He’s spoken about Messi’s unpredictability, control, and ability to embarrass even elite backlines. 
            His words close this journey with a grounded, powerful perspective.
          </p>
        </div>
      </motion.div>
    </section>
